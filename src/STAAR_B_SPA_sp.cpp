...
// [[Rcpp::export]]
arma::vec STAAR_B_SPA_sp(arma::sp_mat G, arma::mat XW, arma::mat XXWX_inv, arma::vec residuals, arma::vec muhat, arma::mat weights_B, double tol, int max_iter,
double p_filter_cutoff, arma::mat X, arma::vec working, double sigma, int fam)
{
	int i,k;
	double sum0 = 0.0;
